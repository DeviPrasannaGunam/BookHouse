...
<nav class="navbar">
  ...
  <h1 class="title"></h1>
    ...
    <div class="box-container">
      <?php
      $all_orders = mysqli_query($db_connect, "SELECT * FROM `admin_d`");
      ...
      ?>
          ...
          <div class="box">
            ...
            <a href="admin_del.php?delete=<?= $row["a"] ?>" onclick="return confirm('delete the feedback?');" class="delete-btn">delete</a>
        </form>
          </div>
      <?php
        }
